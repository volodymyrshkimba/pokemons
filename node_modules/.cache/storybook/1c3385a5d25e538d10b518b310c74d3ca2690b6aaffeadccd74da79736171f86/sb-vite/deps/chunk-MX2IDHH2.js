...
var T = $((g) => {
  Object.defineProperty(g, "__esModule", { value: true }), g.isEqual = function() {
    ...
    return function(n, a) {
      return s(function d(o, i, p) {
        ...
        if (o == null || i == null)
          return false;
        if (p.indexOf(o) > -1 && p.indexOf(i) > -1)
          return true;
        ...
        switch (m.slice(8, -1)) {
          ...
          case "Map":
            ...
            do
              if (!d((l = c.next()).value, u.next().value, p))
                return false;
            while (!l.done);
            return true;
          case "ArrayBuffer":
          ...
          case "Array":
            ...
            for (l = 0; l < o.length; l++)
              if ((l in o || l in i) && (l in o != l in i || !d(o[l], i[l], p)))
                return false;
            return true;
          case "Object":
            return d(r(o), r(i), p);
...
//# sourceMappingURL=chunk-MX2IDHH2.js.map
