import { readFile, lstat, readdir as readdir$1, readlink, realpath, mkdir, writeFile } from 'node:fs/promises';
import { NoStatsForViteDevError } from 'storybook/internal/server-errors';
import { logger } from 'storybook/internal/node-logger';
import { dedent } from 'ts-dedent';
import { getBuilderOptions, resolvePathInStorybookCache, isPreservingSymlinks, getFrameworkName, stringifyEnvs, normalizeStories, commonGlobOptions, loadPreviewOrConfigFile, stripAbsNodeModulesPath } from 'storybook/internal/common';
import { win32, posix, resolve as resolve$1, relative as relative$1, join, isAbsolute as isAbsolute$1, dirname } from 'node:path';
...
`)}])
  ...
  }`,generateHMRHandler=frameworkName2=>frameworkName2==="@storybook/web-components-vite"?dedent`
      if (import.meta.hot) {
  ...
  ${generateHMRHandler(frameworkName)};`.trim()}async function generateAddonSetupCode(){return `
