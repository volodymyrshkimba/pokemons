...
import React10__default, { memo, useState, useRef, useEffect, useMemo, Fragment, useContext } from 'react';
import { IconButton, TooltipNote, Button, Separator, P, ProgressSpinner, AddonPanel, Modal, EmptyTabContent, Link, WithTooltip, Bar, Spaced, Badge, ListItem } from 'storybook/internal/components';
import { experimental_UniversalStore, useStorybookState, useAddonState, useChannel, useParameter, addons, types, Consumer, useStorybookApi, experimental_useUniversalStore } from 'storybook/internal/manager-api';
import { Addon_TypesEnum } from 'storybook/internal/types';
import { styled, typography, useTheme } from 'storybook/internal/theming';
import { StopAltIcon, SyncIcon, CloseIcon, VideoIcon, DocumentIcon, ListUnorderedIcon, RewindIcon, PlayBackIcon, PlayNextIcon, FastForwardIcon, EditIcon, EyeIcon, PlayHollowIcon, PointerHandIcon, AccessibilityIcon, ShieldIcon, CircleIcon, PlayIcon, CheckIcon } from '@storybook/icons';
...
`),more=paragraphs.length>1;return React10.createElement(RowMessage,null,React10.createElement("pre",{dangerouslySetInnerHTML:{__html:filter.toHtml(paragraphs[0])}}),more&&React10.createElement("p",null,"See the full stack trace in the browser console."))},Interaction=({call,callsById,controls,controlStates,childCallIds,isHidden,isCollapsed,toggleCollapsed,pausedAt})=>{let[isHovered,setIsHovered]=React10.useState(!1),isInteractive=!controlStates.goto||!call.interceptable||!!call.ancestors?.length;return isHidden?null:React10.createElement(RowContainer,{call,pausedAt},React10.createElement(RowHeader,{isInteractive},React10.createElement(RowLabel,{"aria-label":"Interaction step",call,onClick:()=>controls.goto(call.id),disabled:isInteractive,onMouseEnter:()=>controlStates.goto&&setIsHovered(!0),onMouseLeave:()=>controlStates.goto&&setIsHovered(!1)},React10.createElement(StatusIcon,{status:isHovered?CallStates.ACTIVE:call.status}),React10.createElement(MethodCallWrapper,{style:{marginLeft:6,marginBottom:1}},React10.createElement(MethodCall,{call,callsById}))),React10.createElement(RowActions,null,(childCallIds?.length??0)>0&&React10.createElement(WithTooltip,{hasChrome:!1,tooltip:React10.createElement(Note,{note:`${isCollapsed?"Show":"Hide"} interactions`})},React10.createElement(StyledIconButton,{onClick:toggleCollapsed},React10.createElement(ListUnorderedIcon,null))))),call.status===CallStates.ERROR&&call.exception?.callId===call.id&&React10.createElement(Exception,{exception:call.exception}))};var StyledBadge=styled.div(({theme,status})=>({padding:"4px 6px 4px 8px;",borderRadius:"4px",backgroundColor:{[CallStates.DONE]:theme.color.positive,[CallStates.ERROR]:theme.color.negative,[CallStates.ACTIVE]:theme.color.warning,[CallStates.WAITING]:theme.color.warning}[status],color:"white",fontFamily:typography.fonts.base,textTransform:"uppercase",fontSize:typography.size.s1,letterSpacing:3,fontWeight:typography.weight.bold,width:65,textAlign:"center"})),StatusBadge=({status})=>{let badgeText={[CallStates.DONE]:"Pass",[CallStates.ERROR]:"Fail",[CallStates.ACTIVE]:"Runs",[CallStates.WAITING]:"Runs"}[status];return React10__default.createElement(StyledBadge,{"aria-label":"Status of the test run",status},badgeText)};var SubnavWrapper=styled.div(({theme})=>({background:theme.background.app,borderBottom:`1px solid ${theme.appBorderColor}`,position:"sticky",top:0,zIndex:1})),StyledSubnav=styled.nav(({theme})=>({height:40,display:"flex",alignItems:"center",justifyContent:"space-between",paddingLeft:15})),StyledButton=styled(Button)(({theme})=>({borderRadius:4,padding:6,color:theme.textMutedColor,"&:not(:disabled)":{"&:hover,&:focus-visible":{color:theme.color.secondary}}})),Note2=styled(TooltipNote)(({theme})=>({fontFamily:theme.typography.fonts.base})),StyledIconButton2=styled(IconButton)(({theme})=>({color:theme.textMutedColor,margin:"0 3px"})),StyledSeparator=styled(Separator)({marginTop:0}),StyledLocation=styled(P)(({theme})=>({color:theme.textMutedColor,justifyContent:"flex-end",textAlign:"right",whiteSpace:"nowrap",marginTop:"auto",marginBottom:1,paddingRight:15,fontSize:13})),Group=styled.div({display:"flex",alignItems:"center"}),RewindButton=styled(StyledIconButton2)({marginLeft:9}),JumpToEndButton=styled(StyledButton)({marginLeft:9,marginRight:9,marginBottom:1,lineHeight:"12px"}),RerunButton=styled(StyledIconButton2)(({theme,animating,disabled})=>({opacity:disabled?.5:1,svg:{animation:animating?`${theme.animation.rotate360} 200ms ease-out`:void 0}})),Subnav=({controls,controlStates,status,storyFileName,onScrollToEnd})=>{let buttonText=status===CallStates.ERROR?"Scroll to error":"Scroll to end";return React10__default.createElement(SubnavWrapper,null,React10__default.createElement(Bar,null,React10__default.createElement(StyledSubnav,null,React10__default.createElement(Group,null,React10__default.createElement(StatusBadge,{status}),React10__default.createElement(JumpToEndButton,{onClick:onScrollToEnd,disabled:!onScrollToEnd},buttonText),React10__default.createElement(StyledSeparator,null),React10__default.createElement(WithTooltip,{trigger:"hover",hasChrome:!1,tooltip:React10__default.createElement(Note2,{note:"Go to start"})},React10__default.createElement(RewindButton,{"aria-label":"Go to start",onClick:controls.start,disabled:!controlStates.start},React10__default.createElement(RewindIcon,null))),React10__default.createElement(WithTooltip,{trigger:"hover",hasChrome:!1,tooltip:React10__default.createElement(Note2,{note:"Go back"})},React10__default.createElement(StyledIconButton2,{"aria-label":"Go back",onClick:controls.back,disabled:!controlStates.back},React10__default.createElement(PlayBackIcon,null))),React10__default.createElement(WithTooltip,{trigger:"hover",hasChrome:!1,tooltip:React10__default.createElement(Note2,{note:"Go forward"})},React10__default.createElement(StyledIconButton2,{"aria-label":"Go forward",onClick:controls.next,disabled:!controlStates.next},React10__default.createElement(PlayNextIcon,null))),React10__default.createElement(WithTooltip,{trigger:"hover",hasChrome:!1,tooltip:React10__default.createElement(Note2,{note:"Go to end"})},React10__default.createElement(StyledIconButton2,{"aria-label":"Go to end",onClick:controls.end,disabled:!controlStates.end},React10__default.createElement(FastForwardIcon,null))),React10__default.createElement(WithTooltip,{trigger:"hover",hasChrome:!1,tooltip:React10__default.createElement(Note2,{note:"Rerun"})},React10__default.createElement(RerunButton,{"aria-label":"Rerun",onClick:controls.rerun},React10__default.createElement(SyncIcon,null)))),storyFileName&&React10__default.createElement(Group,null,React10__default.createElement(StyledLocation,null,storyFileName)))))};var Wrapper=styled.div(({theme:{color,typography:typography4,background}})=>({textAlign:"start",padding:"11px 15px",fontSize:`${typography4.size.s2}px`,fontWeight:typography4.weight.regular,lineHeight:"1rem",background:background.app,borderBottom:`1px solid ${color.border}`,color:color.defaultText,backgroundClip:"padding-box",position:"relative",code:{fontSize:`${typography4.size.s1-1}px`,color:"inherit",margin:"0 0.2em",padding:"0 0.2em",background:"rgba(255, 255, 255, 0.8)",borderRadius:"2px",boxShadow:"0 0 0 1px rgba(0, 0, 0, 0.1)"}})),TestDiscrepancyMessage=({browserTestStatus})=>{let docsUrl=useStorybookApi().getDocsUrl({subpath:DOCUMENTATION_DISCREPANCY_LINK,versioned:!0,renderer:!0}),[passed,failed]=browserTestStatus===CallStates.ERROR?["the CLI","this browser"]:["this browser","the CLI"];return React10__default.createElement(Wrapper,null,"This component test passed in ",passed,", but the tests failed in ",failed,"."," ",React10__default.createElement(Link,{href:docsUrl,target:"_blank",withArrow:!0},"Learn what could cause this"))};var Container=styled.div(({theme})=>({height:"100%",background:theme.background.content})),CaughtException=styled.div(({theme})=>({borderBottom:`1px solid ${theme.appBorderColor}`,backgroundColor:theme.base==="dark"?transparentize(.93,theme.color.negative):theme.background.warning,padding:15,fontSize:theme.typography.size.s2-1,lineHeight:"19px"})),CaughtExceptionCode=styled.code(({theme})=>({margin:"0 1px",padding:3,fontSize:theme.typography.size.s1-1,lineHeight:1,verticalAlign:"top",background:"rgba(0, 0, 0, 0.05)",border:`1px solid ${theme.appBorderColor}`,borderRadius:3})),CaughtExceptionTitle=styled.div({paddingBottom:4,fontWeight:"bold"}),CaughtExceptionDescription=styled.p({margin:0,padding:"0 0 20px"}),CaughtExceptionStack=styled.pre(({theme})=>({margin:0,padding:0,"&:not(:last-child)":{paddingBottom:16},fontSize:theme.typography.size.s1-1})),InteractionsPanel=React10.memo(function({calls,controls,controlStates,interactions,fileName,hasException,caughtException,unhandledErrors,isPlaying,pausedAt,onScrollToEnd,endRef,hasResultMismatch,browserTestStatus}){let filter=useAnsiToHtmlFilter();return React10.createElement(Container,null,hasResultMismatch&&React10.createElement(TestDiscrepancyMessage,{browserTestStatus}),(interactions.length>0||hasException)&&React10.createElement(Subnav,{controls,controlStates,status:browserTestStatus,storyFileName:fileName,onScrollToEnd}),React10.createElement("div",{"aria-label":"Interactions list"},interactions.map(call=>React10.createElement(Interaction,{key:call.id,call,callsById:calls,controls,controlStates,childCallIds:call.childCallIds,isHidden:call.isHidden,isCollapsed:call.isCollapsed,toggleCollapsed:call.toggleCollapsed,pausedAt}))),caughtException&&!isTestAssertionError(caughtException)&&React10.createElement(CaughtException,null,React10.createElement(CaughtExceptionTitle,null,"Caught exception in ",React10.createElement(CaughtExceptionCode,null,"play")," function"),React10.createElement(CaughtExceptionStack,{"data-chromatic":"ignore",dangerouslySetInnerHTML:{__html:filter.toHtml(printSerializedError(caughtException))}})),unhandledErrors&&React10.createElement(CaughtException,null,React10.createElement(CaughtExceptionTitle,null,"Unhandled Errors"),React10.createElement(CaughtExceptionDescription,null,"Found ",unhandledErrors.length," unhandled error",unhandledErrors.length>1?"s":""," ","while running the play function. This might cause false positive assertions. Resolve unhandled errors or ignore unhandled errors with setting the",React10.createElement(CaughtExceptionCode,null,"test.dangerouslyIgnoreUnhandledErrors")," ","parameter to ",React10.createElement(CaughtExceptionCode,null,"true"),"."),unhandledErrors.map((error,i)=>React10.createElement(CaughtExceptionStack,{key:i,"data-chromatic":"ignore"},printSerializedError(error)))),React10.createElement("div",{ref:endRef}),!isPlaying&&!caughtException&&interactions.length===0&&React10.createElement(Empty,null))});function printSerializedError(error){return error.stack||`${error.name}: ${error.message}`}var INITIAL_CONTROL_STATES={start:!1,back:!1,goto:!1,next:!1,end:!1},statusMap={[CallStates.DONE]:"success",[CallStates.ERROR]:"error",[CallStates.ACTIVE]:"pending",[CallStates.WAITING]:"pending"},getInteractions=({log,calls,collapsed,setCollapsed})=>{let callsById=new Map,childCallMap=new Map;return log.map(({callId,ancestors,status})=>{let isHidden=!1;return ancestors.forEach(ancestor=>{collapsed.has(ancestor)&&(isHidden=!0),childCallMap.set(ancestor,(childCallMap.get(ancestor)||[]).concat(callId));}),{...calls.get(callId),status,isHidden}}).map(call=>{let status=call.status===CallStates.ERROR&&call.ancestors&&callsById.get(call.ancestors.slice(-1)[0])?.status===CallStates.ACTIVE?CallStates.ACTIVE:call.status;return callsById.set(call.id,{...call,status}),{...call,status,childCallIds:childCallMap.get(call.id),isCollapsed:collapsed.has(call.id),toggleCollapsed:()=>setCollapsed(ids=>(ids.has(call.id)?ids.delete(call.id):ids.add(call.id),new Set(ids)))}})},Panel=memo(function({storyId}){let{status:storyStatuses}=useStorybookState(),[addonState,set]=useAddonState(ADDON_ID,{controlStates:INITIAL_CONTROL_STATES,isErrored:!1,pausedAt:void 0,interactions:[],isPlaying:!1,hasException:!1,caughtException:void 0,interactionsCount:0,unhandledErrors:void 0}),[scrollTarget,setScrollTarget]=useState(void 0),[collapsed,setCollapsed]=useState(new Set),[hasResultMismatch,setResultMismatch]=useState(!1),{controlStates=INITIAL_CONTROL_STATES,isErrored=!1,pausedAt=void 0,interactions=[],isPlaying=!1,caughtException=void 0,unhandledErrors=void 0}=addonState,log=useRef([]),calls=useRef(new Map),setCall=({status,...call})=>calls.current.set(call.id,call),endRef=useRef();useEffect(()=>{let observer;return global.IntersectionObserver&&(observer=new global.IntersectionObserver(([end])=>setScrollTarget(end.isIntersecting?void 0:end.target),{root:global.document.querySelector("#panel-tab-content")}),endRef.current&&observer.observe(endRef.current)),()=>observer?.disconnect()},[]);let emit=useChannel({[EVENTS.CALL]:setCall,[EVENTS.SYNC]:payload=>{set(s=>{let list=getInteractions({log:payload.logItems,calls:calls.current,collapsed,setCollapsed});return {...s,controlStates:payload.controlStates,pausedAt:payload.pausedAt,interactions:list,interactionsCount:list.filter(({method})=>method!=="step").length}}),log.current=payload.logItems;},[STORY_RENDER_PHASE_CHANGED]:event=>{if(event.newPhase==="preparing"){set({controlStates:INITIAL_CONTROL_STATES,isErrored:!1,pausedAt:void 0,interactions:[],isPlaying:!1,hasException:!1,caughtException:void 0,interactionsCount:0,unhandledErrors:void 0});return}set(s=>({...s,isPlaying:event.newPhase==="playing",pausedAt:void 0,...event.newPhase==="rendering"?{isErrored:!1,caughtException:void 0}:{}}));},[STORY_THREW_EXCEPTION]:()=>{set(s=>({...s,isErrored:!0,hasException:!0}));},[PLAY_FUNCTION_THREW_EXCEPTION]:e=>{set(s=>({...s,caughtException:e,hasException:!0}));},[UNHANDLED_ERRORS_WHILE_PLAYING]:e=>{set(s=>({...s,unhandledErrors:e,hasException:!0}));}},[collapsed]);useEffect(()=>{set(s=>{let list=getInteractions({log:log.current,calls:calls.current,collapsed,setCollapsed});return {...s,interactions:list,interactionsCount:list.filter(({method})=>method!=="step").length}});},[set,collapsed]);let controls=useMemo(()=>({start:()=>emit(EVENTS.START,{storyId}),back:()=>emit(EVENTS.BACK,{storyId}),goto:callId=>emit(EVENTS.GOTO,{storyId,callId}),next:()=>emit(EVENTS.NEXT,{storyId}),end:()=>emit(EVENTS.END,{storyId}),rerun:()=>{emit(FORCE_REMOUNT,{storyId});}}),[emit,storyId]),storyFilePath=useParameter("fileName",""),[fileName]=storyFilePath.toString().split("/").slice(-1),scrollToTarget=()=>scrollTarget?.scrollIntoView({behavior:"smooth",block:"end"}),hasException=!!caughtException||!!unhandledErrors||interactions.some(v=>v.status===CallStates.ERROR),storyStatus=storyStatuses[storyId]?.[TEST_PROVIDER_ID],storyTestStatus=storyStatus?.status,browserTestStatus=useMemo(()=>!isPlaying&&(interactions.length>0||hasException)?hasException?CallStates.ERROR:CallStates.DONE:isPlaying?CallStates.ACTIVE:void 0,[isPlaying,interactions,hasException]),{testRunId}=storyStatus?.data||{};return useEffect(()=>{if(browserTestStatus&&storyTestStatus&&storyTestStatus!=="pending"&&storyTestStatus!==statusMap[browserTestStatus]){let timeout=setTimeout(()=>setResultMismatch(currentValue=>(currentValue||emit(STORYBOOK_ADDON_TEST_CHANNEL,{type:"test-discrepancy",payload:{browserStatus:browserTestStatus===CallStates.DONE?"PASS":"FAIL",cliStatus:browserTestStatus===CallStates.DONE?"FAIL":"PASS",storyId,testRunId}}),!0)),2e3);return ()=>clearTimeout(timeout)}else setResultMismatch(!1);},[emit,browserTestStatus,storyTestStatus,storyId,testRunId]),isErrored?React10__default.createElement(Fragment,{key:"component-tests"}):React10__default.createElement(Fragment,{key:"component-tests"},React10__default.createElement(InteractionsPanel,{hasResultMismatch,browserTestStatus,calls:calls.current,controls,controlStates,interactions,fileName,hasException,caughtException,unhandledErrors,isPlaying,pausedAt,endRef,onScrollToEnd:scrollTarget&&scrollToTarget}))});function PanelTitle(){let[addonState={}]=useAddonState(ADDON_ID),{hasException,interactionsCount}=addonState;return React10__default.createElement("div",null,React10__default.createElement(Spaced,{col:1},React10__default.createElement("span",{style:{display:"inline-block",verticalAlign:"middle"}},"Component tests"),interactionsCount&&!hasException?React10__default.createElement(Badge,{status:"neutral"},interactionsCount):null,hasException?React10__default.createElement(Badge,{status:"negative"},interactionsCount):null))}var ADDON_ID2="storybook/a11y",PANEL_ID2=`${ADDON_ID2}/panel`;var RelativeTime=({timestamp})=>{let[timeAgo,setTimeAgo]=useState(null);if(useEffect(()=>{if(timestamp){setTimeAgo(Date.now()-timestamp);let interval=setInterval(()=>setTimeAgo(Date.now()-timestamp),1e4);return ()=>clearInterval(interval)}},[timestamp]),timeAgo===null)return null;let seconds=Math.round(timeAgo/1e3);if(seconds<60)return "just now";let minutes=Math.floor(seconds/60);if(minutes<60)return minutes===1?"a minute ago":`${minutes} minutes ago`;let hours=Math.floor(minutes/60);if(hours<24)return hours===1?"an hour ago":`${hours} hours ago`;let days=Math.floor(hours/24);return days===1?"yesterday":`${days} days ago`};var Wrapper2=styled.div(({theme})=>({overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis",fontSize:theme.typography.size.s1,color:theme.textMutedColor}));styled.span(({theme})=>({color:theme.color.positiveText}));function Description({state,watching,entryId,results,...props}){let{setModalOpen}=React10__default.useContext(GlobalErrorContext),errorMessage=state.error?.message,description="Not run";return state.running?description=state.progress?`Testing... ${state.progress.numPassedTests}/${state.progress.numTotalTests}`:"Starting...":entryId&&results?.length?description=`Ran ${results.length} ${results.length===1?"test":"tests"}`:state.failed&&!errorMessage?description="Failed":state.crashed||state.failed&&errorMessage?description=setModalOpen?React10__default.createElement(Link,{isButton:!0,onClick:()=>setModalOpen(!0)},state.error?.name||"View full error"):state.error?.name||"Failed":state.progress?.finishedAt?description=React10__default.createElement(React10__default.Fragment,null,"Ran ",state.progress.numTotalTests," ",state.progress.numTotalTests===1?"test":"tests"," ",React10__default.createElement(RelativeTime,{timestamp:state.progress.finishedAt})):watching&&(description="Watching for file changes"),React10__default.createElement(Wrapper2,{...props},description)}var TestStatusIcon=styled.div(({percentage})=>({width:percentage?12:6,height:percentage?12:6,margin:percentage?1:4,background:percentage?`conic-gradient(var(--status-color) ${percentage}%, var(--status-background) ${percentage+1}%)`:"var(--status-color)",borderRadius:"50%"}),({status,theme})=>status==="pending"&&{animation:`${theme.animation.glow} 1.5s ease-in-out infinite`,"--status-color":theme.color.mediumdark,"--status-background":`${theme.color.mediumdark}66`},({status,theme})=>status==="positive"&&{"--status-color":theme.color.positive,"--status-background":`${theme.color.positive}66`},({status,theme})=>status==="warning"&&{"--status-color":theme.color.gold,"--status-background":`${theme.color.gold}66`},({status,theme})=>status==="negative"&&{"--status-color":theme.color.negative,"--status-background":`${theme.color.negative}66`},({status,theme})=>status==="critical"&&{"--status-color":theme.color.defaultText,"--status-background":`${theme.color.defaultText}66`},({status,theme})=>status==="unknown"&&{"--status-color":theme.color.mediumdark,"--status-background":`${theme.color.mediumdark}66`});var Container2=styled.div({display:"flex",flexDirection:"column"}),Heading=styled.div({display:"flex",justifyContent:"space-between",padding:"8px 2px",gap:12}),Info=styled.div({display:"flex",flexDirection:"column",marginLeft:6,minWidth:0}),Title=styled.div(({crashed,theme})=>({fontSize:theme.typography.size.s1,fontWeight:crashed?"bold":"normal",color:crashed?theme.color.negativeText:theme.color.defaultText})),Actions=styled.div({display:"flex",gap:2}),Extras=styled.div({marginBottom:2}),Checkbox=styled.input({margin:0,"&:enabled":{cursor:"pointer"}}),Progress=styled(ProgressSpinner)({margin:2}),StopIcon=styled(StopAltIcon)({width:10}),ItemTitle=styled.span(({enabled,theme})=>!enabled&&{color:theme.textMutedColor,"&:after":{content:'" (disabled)"'}}),statusOrder=["failed","warning","pending","passed","skipped"],statusMap2={failed:"negative",warning:"warning",passed:"positive",skipped:"unknown",pending:"pending"},TestProviderRender=({state,api,entryId,...props})=>{let[isEditing,setIsEditing]=useState(!1),theme=useTheme(),coverageSummary=state.details?.coverageSummary,isA11yAddon=addons.experimental_getRegisteredAddons().includes(ADDON_ID2),[{config,watching},setStoreState]=experimental_useUniversalStore(store),isStoryEntry=entryId?.includes("--")??!1,a11yResults=useMemo(()=>isA11yAddon?state.details?.testResults?.flatMap(result=>result.results.filter(Boolean).filter(r=>!entryId||r.storyId===entryId||r.storyId?.startsWith(`${entryId}-`)).map(r=>r.reports.find(report=>report.type==="a11y"))):[],[isA11yAddon,state.details?.testResults,entryId]),a11yStatus=useMemo(()=>{if(state.running||!isA11yAddon||config.a11y===!1)return "unknown";let definedA11yResults=a11yResults?.filter(Boolean)??[];if(!definedA11yResults||definedA11yResults.length===0)return "unknown";let failed=definedA11yResults.some(result=>result?.status==="failed"),warning=definedA11yResults.some(result=>result?.status==="warning");return failed?"negative":warning?"warning":"positive"},[state.running,isA11yAddon,config.a11y,a11yResults]),a11yNotPassedAmount=config?.a11y?a11yResults?.filter(result=>result?.status==="failed"||result?.status==="warning").length:void 0,a11ySkippedAmount=state.running||!config?.a11y?null:a11yResults?.filter(result=>!result).length,a11ySkippedLabel=a11ySkippedAmount?a11ySkippedAmount===1&&isStoryEntry?"(skipped)":`(${a11ySkippedAmount} skipped)`:"",storyId=isStoryEntry?entryId:void 0,results=(state.details?.testResults||[]).flatMap(test=>entryId?test.results.filter(result=>storyId?result.storyId===storyId:result.storyId?.startsWith(`${entryId}-`)):test.results).sort((a,b)=>statusOrder.indexOf(a.status)-statusOrder.indexOf(b.status)),status=results[0]?.status??(state.running?"pending":"unknown"),openPanel=(id,panelId)=>{api.selectStory(id),api.setSelectedPanel(panelId),api.togglePanel(!0);};return React10__default.createElement(Container2,{...props},React10__default.createElement(Heading,null,React10__default.createElement(Info,null,React10__default.createElement(Title,{id:"testing-module-title",crashed:state.crashed},state.crashed?"Local tests failed":"Run local tests"),React10__default.createElement(Description,{id:"testing-module-description",state,entryId,results,watching})),React10__default.createElement(Actions,null,!entryId&&React10__default.createElement(WithTooltip,{hasChrome:!1,trigger:"hover",tooltip:React10__default.createElement(TooltipNote,{note:`${isEditing?"Hide":"Show"} settings`})},React10__default.createElement(Button,{"aria-label":`${isEditing?"Hide":"Show"} settings`,variant:"ghost",padding:"small",active:isEditing,disabled:state.running&&!isEditing,onClick:()=>setIsEditing(!isEditing)},React10__default.createElement(EditIcon,null))),!entryId&&React10__default.createElement(WithTooltip,{hasChrome:!1,trigger:"hover",tooltip:React10__default.createElement(TooltipNote,{note:`${watching?"Disable":"Enable"} watch mode`})},React10__default.createElement(Button,{"aria-label":`${watching?"Disable":"Enable"} watch mode`,variant:"ghost",padding:"small",active:watching,onClick:()=>setStoreState(s=>({...s,watching:!watching})),disabled:state.running||isEditing},React10__default.createElement(EyeIcon,null))),state.runnable&&React10__default.createElement(React10__default.Fragment,null,state.running&&state.cancellable?React10__default.createElement(WithTooltip,{hasChrome:!1,trigger:"hover",tooltip:React10__default.createElement(TooltipNote,{note:"Stop test run"})},React10__default.createElement(Button,{"aria-label":"Stop test run",variant:"ghost",padding:"none",onClick:()=>api.cancelTestProvider(state.id),disabled:state.cancelling},React10__default.createElement(Progress,{percentage:state.progress?.percentageCompleted},React10__default.createElement(StopIcon,null)))):React10__default.createElement(WithTooltip,{hasChrome:!1,trigger:"hover",tooltip:React10__default.createElement(TooltipNote,{note:"Start test run"})},React10__default.createElement(Button,{"aria-label":"Start test run",variant:"ghost",padding:"small",onClick:()=>api.runTestProvider(state.id,{entryId}),disabled:state.running||isEditing},React10__default.createElement(PlayHollowIcon,null)))))),isEditing?React10__default.createElement(Extras,null,React10__default.createElement(ListItem,{as:"label",title:"Component tests",icon:React10__default.createElement(PointerHandIcon,{color:theme.textMutedColor}),right:React10__default.createElement(Checkbox,{type:"checkbox",checked:!0,disabled:!0})}),isA11yAddon&&React10__default.createElement(ListItem,{as:"label",title:React10__default.createElement(ItemTitle,{enabled:config.a11y},"Accessibility"),icon:React10__default.createElement(AccessibilityIcon,{color:theme.textMutedColor}),right:React10__default.createElement(Checkbox,{type:"checkbox",checked:config.a11y,onChange:()=>setStoreState(s=>({...s,config:{...s.config,a11y:!config.a11y}}))})}),!entryId&&React10__default.createElement(ListItem,{as:"label",title:React10__default.createElement(ItemTitle,{enabled:config.coverage},"Coverage"),icon:React10__default.createElement(ShieldIcon,{color:theme.textMutedColor}),right:React10__default.createElement(Checkbox,{type:"checkbox",checked:watching?!1:config.coverage,disabled:watching,onChange:()=>setStoreState(s=>({...s,config:{...s.config,coverage:!config.coverage}}))})})):React10__default.createElement(Extras,null,React10__default.createElement(ListItem,{title:"Component tests",onClick:(status==="failed"||status==="warning")&&results.length?()=>{let firstNotPassed=results.find(r=>r.status==="failed"||r.status==="warning");firstNotPassed&&openPanel(firstNotPassed.storyId,PANEL_ID);}:void 0,icon:state.crashed?React10__default.createElement(TestStatusIcon,{status:"critical","aria-label":"status: crashed"}):status==="unknown"?React10__default.createElement(TestStatusIcon,{status:"unknown","aria-label":"status: unknown"}):React10__default.createElement(TestStatusIcon,{status:statusMap2[status],"aria-label":`status: ${status}`})}),isA11yAddon&&React10__default.createElement(ListItem,{title:React10__default.createElement(ItemTitle,{enabled:config.a11y},"Accessibility ",a11ySkippedLabel),onClick:(a11yStatus==="negative"||a11yStatus==="warning")&&a11yResults.length?()=>{let firstNotPassed=results.find(r=>r.reports.filter(report=>report.type==="a11y").find(report=>report.status==="failed"||report.status==="warning"));firstNotPassed&&openPanel(firstNotPassed.storyId,PANEL_ID2);}:void 0,icon:React10__default.createElement(TestStatusIcon,{status:a11yStatus,"aria-label":`status: ${a11yStatus}`}),right:isStoryEntry?null:a11yNotPassedAmount||null}),!entryId&&React10__default.createElement(React10__default.Fragment,null,coverageSummary?React10__default.createElement(ListItem,{title:React10__default.createElement(ItemTitle,{enabled:config.coverage},"Coverage"),href:"/coverage/index.html",target:"_blank","aria-label":"Open coverage report",icon:React10__default.createElement(TestStatusIcon,{percentage:coverageSummary.percentage,status:coverageSummary.status,"aria-label":`status: ${coverageSummary.status}`}),right:coverageSummary.percentage?React10__default.createElement("span",{"aria-label":`${coverageSummary.percentage} percent coverage`},coverageSummary.percentage," %"):null}):React10__default.createElement(ListItem,{title:React10__default.createElement(ItemTitle,{enabled:config.coverage},"Coverage"),icon:React10__default.createElement(TestStatusIcon,{status:"unknown","aria-label":"status: unknown"})}))))};var statusMap3={failed:"error",passed:"success",pending:"pending",warning:"warn",skipped:"unknown"};addons.register(ADDON_ID,api=>{if((globalThis.STORYBOOK_BUILDER||"").includes("vite")){let openTestsPanel=()=>{api.setSelectedPanel(PANEL_ID),api.togglePanel(!0);};addons.add(TEST_PROVIDER_ID,{type:Addon_TypesEnum.experimental_TEST_PROVIDER,runnable:!0,name:"Component tests",render:state=>{let[isModalOpen,setModalOpen]=useState(!1);return React10__default.createElement(GlobalErrorContext.Provider,{value:{error:state.error?.message,isModalOpen,setModalOpen}},React10__default.createElement(TestProviderRender,{api,state}),React10__default.createElement(GlobalErrorModal,{onRerun:()=>{setModalOpen(!1),api.runTestProvider(TEST_PROVIDER_ID);}}))},sidebarContextMenu:({context,state})=>context.type==="docs"||context.type==="story"&&!context.tags.includes("test")?null:React10__default.createElement(TestProviderRender,{api,state,entryId:context.id,style:{minWidth:240}}),stateUpdater:(state,update)=>{let updated={...state,...update,details:{...state.details,...update.details}};return (!state.running&&update.running||store.getState().watching)&&delete updated.details.coverageSummary,update.details?.testResults&&(async()=>(await api.experimental_updateStatus(TEST_PROVIDER_ID,Object.fromEntries(update.details.testResults.flatMap(testResult=>testResult.results.filter(({storyId})=>storyId).map(({storyId,status,testRunId,...rest})=>[storyId,{title:"Component tests",status:statusMap3[status],description:"failureMessages"in rest&&rest.failureMessages?rest.failureMessages.join(`
`):"",data:{testRunId},onClick:openTestsPanel,sidebarContextMenu:!1}])))),await api.experimental_updateStatus("storybook/addon-a11y/test-provider",Object.fromEntries(update.details.testResults.flatMap(testResult=>testResult.results.filter(({storyId})=>storyId).map(({storyId,testRunId,reports})=>{let a11yReport=reports.find(r=>r.type==="a11y");return [storyId,a11yReport?{title:"Accessibility tests",description:"",status:statusMap3[a11yReport.status],data:{testRunId},onClick:()=>{api.setSelectedPanel("storybook/a11y/panel"),api.togglePanel(!0);},sidebarContextMenu:!1}:null]}))))))(),updated}});}let filter=({state})=>({storyId:state.storyId});addons.add(PANEL_ID,{type:types.PANEL,title:()=>React10__default.createElement(PanelTitle,null),match:({viewMode})=>viewMode==="story",render:({active})=>React10__default.createElement(AddonPanel,{active:!!active},React10__default.createElement(Consumer,{filter},({storyId})=>React10__default.createElement(Panel,{storyId})))});});
