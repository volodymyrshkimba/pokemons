...
var U0 = Object.getPrototypeOf, j0 = Object.prototype.hasOwnProperty;
...
var er = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), L = (e, t) => {
  for (var r in t)
    Ce(e, r, { get: t[r], enumerable: !0 });
}, F0 = (e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let o of k0(t))
      !j0.call(e, o) && o !== r && Ce(e, o, { get: () => t[o], enumerable: !(a = N0(t, o)) || a.enumerable });
  return e;
};
var ze = (e, t, r) => (r = e != null ? D0(U0(e)) : {}, F0(
...
var Be = er((Dr, pt) => {
  (function(e) {
    if (typeof Dr == "object" && typeof pt < "u")
      pt.exports = e();
...
var nr = "[object RegExp]", or = "[object String]", lr = "[object Number]", ir = "[object Boolean]", tt = "[object Arguments]", sr = "[objec\
t Symbol]", cr = "[object Date]", fr = "[object Map]", dr = "[object Set]", hr = "[object Array]", ur = "[object Function]", pr = "[object A\
rrayBuffer]", Le = "[object Object]", vr = "[object Error]", mr = "[object DataView]", gr = "[object Uint8Array]", wr = "[object Uint8Clampe\
dArray]", yr = "[object Uint16Array]", Rr = "[object Uint32Array]", Sr = "[object BigUint64Array]", Er = "[object Int8Array]", Ir = "[object\
 Int16Array]", xr = "[object Int32Array]", Ar = "[object BigInt64Array]", Pr = "[object Float32Array]", br = "[object Float64Array]";
...
import { createContext as G0 } from "react";
var _r = /* @__PURE__ */ n(({ api: e, state: t }) => G0({ api: e, state: t }), "createContext");

// src/manager-api/lib/merge.ts
import { logger as Mr } from "@storybook/core/client-logger";
var $ = /* @__PURE__ */ n((e, ...t) => {
  let r = {};
  r = Y({}, e, (a, o) => {
    ...
    if (Array.isArray(a))
      return Mr.log(["the types mismatch, picking", a]), a;
  });
  for (let a of t)
    r = Y(r, a, (o, l) => {
      ...
      if (Array.isArray(o))
        return Mr.log(["the types mismatch, picking", o]), o;
    });
  return r;
}, "default"), Cr = /* @__PURE__ */ n((e, ...t) => {
  let r = {};
  r = Y({}, e, (a, o) => {
    if (Array.isArray(o))
      return o;
...
var $0 = /* @__PURE__ */ n((...e) => e.reduce((t, r) => $(t, r), {}), "main"), Oe = $0;

// src/manager-api/lib/addons.ts
import { Addon_TypesEnum as Tr } from "@storybook/core/types";
...
// src/manager-api/lib/addons.ts
import { logger as K0 } from "@storybook/core/client-logger";
import { SET_CONFIG as zr } from "@storybook/core/core-events";

// src/manager-api/lib/storybook-channel-mock.ts
import { Channel as W0 } from "@storybook/core/channels";
function nt() {
  let e = {
...
var it = class it {
  constructor() {
    ...
    this.setConfig = /* @__PURE__ */ n((t) => {
      Object.assign(this.config, t), this.hasChannel() ? this.getChannel().emit(zr, this.config) : this.ready().then((r) => {
        r.emit(zr, this.config);
      });
    }, "setConfig");
    ...
    this.register = /* @__PURE__ */ n((t, r) => {
      this.loaders[t] && K0.warn(`${t} was loaded twice, this could have bad side-effects`), this.loaders[t] = r;
    }, "register");
...
var Q0 = /* @__PURE__ */ n(({ provider: e }) => ({ api: {
...
import { Addon_TypesEnum as Z0 } from "@storybook/core/types";
import {
  TESTING_MODULE_CANCEL_TEST_RUN_REQUEST as ea,
  TESTING_MODULE_RUN_ALL_REQUEST as ta,
  TESTING_MODULE_RUN_REQUEST as Lr
} from "@storybook/core/core-events";

// ../node_modules/tiny-invariant/dist/esm/tiny-invariant.js
var X0 = !1, dt = "Invariant failed";
function ht(e, t) {
  if (!e) {
    if (X0)
      throw new Error(dt);
...
var ra = {
  ...
  let r = {
    ...
    runTestProvider(l, c) {
      ...
      if (!c?.entryId) {
        ...
        return t.emit(Lr, p), t.emit(ta, { providerId: l }), () => a.cancelTestProvider(l);
      }
      let d = i[c.entryId];
      ...
      return t.emit(Lr, u), () => a.cancelTestProvider(l);
    },
  ...
  return { init: /* @__PURE__ */ n(async () => {
    let l = Object.fromEntries(
      Object.entries(t.getElements(Z0.experimental_TEST_PROVIDER)).map(
        ([c, i]) => [
          c,
          {
            ...i,
  ...
  if (e && t && (r = e.constructor) === t.constructor) {
    ...
    if (r === Set) {
      if (e.size !== t.size)
        return !1;
      for (a of e)
        if (o = a, o && typeof o == "object" && (o = Br(t, o), !o) || !t.has(o)) return !1;
      return !0;
    }
    if (r === Map) {
      if (e.size !== t.size)
        return !1;
      for (a of e)
        if (o = a[0], o && typeof o == "object" && (o = Br(t, o), !o) || !N(a[1], t.get(o)))
          return !1;
      return !0;
    }
    if (r === ArrayBuffer)
    ...
    if (!r || typeof e == "object") {
      a = 0;
      for (r in e)
        if (Or.call(e, r) && ++a && !Or.call(t, r) || !(r in t) || !N(e[r], t[r])) return !1;
...
var Nr = /* @__PURE__ */ n((e, t) => !Array.isArray(e) || !Array.isArray(t) || !e.length || !t.length ? [] : e.reduce((r, a) => (t.includes(
a) && r.push(a), r), []), "default");

// src/manager-api/lib/stories.ts
var oa = /\s*\/\s*/, kr = /* @__PURE__ */ n(({
  globalParameters: e,
  kindParameters: t,
  stories: r
}) => et(r, (a) => ({
...
var Ur = /* @__PURE__ */ n((e) => ({ v: 5, entries: Object.entries(e).reduce(
  (r, [a, o]) => {
    if (!o)
      return r;
  ...
  function v(g, w) {
    ...
    w.tags = w.children.reduce((y, S) => {
      let E = g[S];
      return y === null ? E.tags : Nr(y, E.tags);
    }, null))), g;
  }
  n(v, "addItem");
...
) : e, "addPreparedStories"), jr = (0, vt.default)(1)((e) => Object.entries(e).reduce((t, r) => {
  let a = r[1];
  return a.type === "component" && t.push([...a.children]), t;
}, [])), Fr = (0, vt.default)(1)((e) => Object.keys(e).filter((t) => ["story", "docs"].includes(e[t].type)));

// src/manager-api/modules/refs.ts
var { location: ca, fetch: $r } = P, gt = /* @__PURE__ */ n((e, t) => {
...
}, "getSourceType"), qr = /* @__PURE__ */ n((e, t) => ({ ...t, kind: t.kind.replace("|", "/") }), "defaultStoryMapper"), Wr = /* @__PURE__ */ n(
...
clude", y = fa(h), S = {
    ...
    setRef: /* @__PURE__ */ n(async (s, { storyIndex: d, setStoriesData: h, ...u }, p = !1) => {
      if (r)
        return;
      let v, m, g, { filters: w } = e.getState(), { storyMapper: y = qr } = t.getConfig(), S = l.getRefs()[s];
      (d || h) && (v = h ? Ur(
        ...
        filters: {},
        status: {}
      })), m && (m = Wr(m, S)), g && (g = Wr(g, S)), await l.updateRef(s, { ...S, ...u, index: m, filteredIndex: g, internal_index: v });
    }, "setRef"),
...
var ga = /* @__PURE__ */ n(({ store: e, fullAPI: t, provider: r }) => {
  ...
  return r.channel?.on(
    ...
    /* @__PURE__ */ n(function({ globals: i, globalTypes: s }) {
      ...
      d ? Object.keys(i).length > 0 && Yr.warn("received globals from a non-local ref. This is not currently supported.") : e.setState({ globals: i,
...
var { document: Ra } = P, Qr = {
...
}, "getIsPanelShown"), Jr = /* @__PURE__ */ n((e) => !Rt(e) && !St(e), "getIsFullscreen"), Ve = /* @__PURE__ */ n((e) => ({
  ...
  let a = {
    toggleFullscreen(l) {
      return e.setState(
        (c) => {
          let i = Jr(c), s = typeof l == "boolean" ? l : !i;
...
// src/manager-api/modules/shortcuts.ts
var { navigator: Mt, document: Xr } = P, Zr = /* @__PURE__ */ n(() => Mt && Mt.platform ? !!Mt.platform.match(/(Mac|iPhone|iPod|iPad)/i) : !1,
"isMacLike"), ne = /* @__PURE__ */ n(() => Zr() ? "meta" : "control", "controlOrMetaKey");
function zt(e) {
    ...
    handleShortcutFeature(i, s) {
      ...
      if (d)
        switch (s?.preventDefault && s.preventDefault(), i) {
          ...
          case "focusIframe": {
            let u = Xr.getElementById("storybook-preview-iframe");
            if (u)
              try {
...
import { sanitize as e0, toId as Ne } from "@storybook/core/csf";
...
var tn = /* @__PURE__ */ n(({
  ...
  let i = {
    ...
    findSiblingStoryId(d, h, u, p) {
      if (p) {
        let g = jr(h), w = g.findIndex((y) => y.includes(d));
        return w === g.length - 1 && u > 0 || w === 0 && u < 0 ? void 0 : g[w + u] ? g[w + u][0] : void 0;
      }
      let v = Fr(h), m = v.indexOf(d);
  ...
  a.channel?.on(
    ...
    let { ref: u } = T(this, e), p = h.v ? kr(h) : h.stories;
    if (u)
...
import { buildArgsParam as t0, queryFromLocation as rn } from "@storybook/core/router";
import {
...
var { window: Ot } = P, Z = /* @__PURE__ */ n((e) => {
  ...
  let { store: t, navigate: r, provider: a, fullAPI: o } = e, l = /* @__PURE__ */ n((d, h = {}, u = {}) => {
    ...
    if (v?.type !== "story")
      return;
    let { args: m, initialArgs: g } = v, w = t0(g, m);
  ...
  return a.channel?.on(ln, () => {
    ...
    let { path: u, hash: p = "", queryParams: v } = c.getUrlState(), m = t0(h, d);
...
// src/manager-api/modules/versions.ts
var { VERSIONCHECK: dn } = P, a0 = (0, n0.default)(1)(() => {
  try {
  ...
  return { init: /* @__PURE__ */ n(async () => {
    let { versions: l = {} } = e.getState(), { latest: c, next: i } = a0();
    await e.setState({
...
var o0 = /* @__PURE__ */ ye.forwardRef(({ color: e = "currentColor", size: t = 14, ...r }, a) => /* @__PURE__ */ ye.createElement(
  "svg",
  {
    width: t,
    height: t,
...
var l0 = "whats-new", yn = /* @__PURE__ */ n(({ fullAPI: e, store: t, provider: r }) => {
  let a = {
    whatsNewData: void 0
  };
  function o(d) {
  ...
  return n(i, "setWhatsNewCache"), { init: /* @__PURE__ */ n(async () => {
    ...
    e.addNotification({
      ...
      icon: /* @__PURE__ */ pn.createElement(o0, null),
      onClear({ dismissed: p }) {
...
var Rn = Object.create, s0 = Object.defineProperty, Sn = Object.getOwnPropertyDescriptor, c0 = Object.getOwnPropertyNames, En = Object.getPrototypeOf,
In = Object.prototype.hasOwnProperty, D = /* @__PURE__ */ n((e, t) => /* @__PURE__ */ n(function() {
  return t || (0, e[c0(e)[0]])((t = { exports: {} }).exports, t), t.exports;
}, "__require"), "__commonJS"), xn = /* @__PURE__ */ n((e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let o of c0(t))
      !In.call(e, o) && o !== r && s0(e, o, { get: /* @__PURE__ */ n(() => t[o], "get"), enumerable: !(a = Sn(t, o)) || a.enumerable });
  return e;
}, "__copyProps"), je = /* @__PURE__ */ n((e, t, r) => (r = e != null ? Rn(En(e)) : {}, xn(
  t || !e || !e.__esModule ? s0(r, "default", { value: e, enumerable: !0 }) : r,
  e
)), "__toESM"), An = [
  "bubbles",
  "cancelBubble",
...
n(f0, "extractEventHiddenProperties");
...
Symbol]")
  ...
  "node_modules/has-symbols/index.js"(e, t) {
    "use strict";
    var r = typeof Symbol < "u" && Symbol, a = m0();
    t.exports = /* @__PURE__ */ n(function() {
...
on]";
  ...
  "node_modules/get-intrinsic/index.js"(e, t) {
    ...
    }() : s, h = g0()(), u = Object.getPrototypeOf || function(U) {
      return U.__proto__;
    ...
    }, "stringToPath3"), V0 = /* @__PURE__ */ n(function(b, C) {
      var _ = b, z;
    ...
    t.exports = /* @__PURE__ */ n(function(b, C) {
      ...
      var _ = ue(b), z = _.length > 0 ? _[0] : "", G = V0("%" + z + "%", C), ee = G.name, H = G.value, Ae = !1, Qe = G.alias;
  ...
  "node_modules/call-bind/index.js"(e, t) {
    "use strict";
    var r = Ut(), a = w0(), o = a("%Function.prototype.apply%"), l = a("%Function.prototype.call%"), c = a("%Reflect.apply%", !0) || r.call(
  ...
  "node_modules/call-bind/callBound.js"(e, t) {
    "use strict";
    var r = w0(), a = Mn(), o = a(r("String.prototype.indexOf"));
  ...
  "node_modules/is-symbol/index.js"(e, t) {
    "use strict";
    var r = Object.prototype.toString, a = g0()();
...
Object && self, jn = kn || Un || Function("return this")(), jt = jn, Fn = jt.Symbol, le = Fn, y0 = Object.prototype, Gn = y0.hasOwnProperty,
$n = y0.toString, Re = le ? le.toStringTag : void 0;
function Wn(e) {
...
n(Jn, "objectToString");
var Qn = Jn, Xn = "[object Null]", Zn = "[object Undefined]", d0 = le ? le.toStringTag : void 0;
function e1(e) {
  return e == null ? e === void 0 ? Zn : Xn : d0 && d0 in Object(e) ? Kn(e) : Qn(e);
}
n(e1, "baseGetTag");
var R0 = e1;
function t1(e) {
...
function n1(e) {
  return typeof e == "symbol" || r1(e) && R0(e) == a1;
}
n(n1, "isSymbol");
var Ft = n1;
function o1(e, t) {
...
n(o1, "arrayMap");
var l1 = o1, i1 = Array.isArray, Gt = i1, s1 = 1 / 0, h0 = le ? le.prototype : void 0, u0 = h0 ? h0.toString : void 0;
function S0(e) {
  if (typeof e == "string")
    return e;
  if (Gt(e))
...
n(f1, "isObject2");
var E0 = f1, d1 = "[object AsyncFunction]", h1 = "[object Function]", u1 = "[object GeneratorFunction]", p1 = "[object Proxy]";
function v1(e) {
  if (!E0(e))
    return !1;
  var t = R0(e);
...
n(v1, "isFunction");
var m1 = v1, g1 = jt["__core-js_shared__"], kt = g1, p0 = function() {
...
n(k1, "isKey");
var U1 = k1, j1 = I0(Object, "create"), Se = j1;
function F1() {
...
ce.prototype.has = To;
ce.prototype.set = Lo;
var x0 = ce, Oo = "Expected a function";
function $t(e, t) {
  ...
  return r.cache = new ($t.Cache || x0)(), r;
}
n($t, "memoize");
$t.Cache = x0;
var Bo = $t, Vo = 500;
...
` && (a = !1)), !r && !a && (l += e[c]);
    ...
    l = e;
  return l;
}, "removeCodeComments"), r5 = (0, A0.default)(1e4)(
  (e) => t5(e).replace(/\n\s*/g, "").trim()
...
function P0(e) {
  if (!Fe(e))
    return e;
  let t = e, r = !1;
  return typeof Event < "u" && e instanceof Event && (t = f0(t), r = !0), t = Object.keys(t).reduce((a, o) => {
    try {
...
n(P0, "convertUnconventionalData");
...
NaN_" ? NaN : typeof value == "string" && value.startsWith("_bigint_") && typeof BigInt == "function" ? BigInt(value.replace("_bigint_", "")) :
  ...
  let r = { ...b0, ...t };
  return JSON.stringify(P0(e), l5(r), t.space);
...
}, "mutator"), M0 = /* @__PURE__ */ n((e, t = {}) => {
  let r = { ...b0, ...t }, a = JSON.parse(e, i5(r));
  return s5()(a), a;
}, "parse");
...
var C0 = /* @__PURE__ */ n((e) => {
  e.fn("set", function(t, r) {
    return e.set(
      ...
      // @ts-expect-error('this' implicitly has type 'any')
      this._in(t),
      _0(r, { maxDepth: 50, allowFunction: !1 })
    );
  }), e.fn("get", function(t, r) {
    let a = e.get(this._area, this._in(t));
    return a !== null ? M0(a) : r || a;
  });
}, "default");

// src/manager-api/store.ts
C0(fe.default._);
var z0 = "@storybook/manager/store";
function Wt(e) {
  return e.get(z0) || {};
}
n(Wt, "get");
...
import { Channel as u5 } from "@storybook/core/channels";
var Ke = class Ke extends J {
  ...
  unsubscribeAll() {
    if (!this.testUtils)
      throw new Error(
        Vr`Cannot call unsubscribeAll on a store that does not have testUtils.
...
var Je = _r({ api: void 0, state: Oe({}) }), Gr = /* @__PURE__ */ n((...e) => Cr({}, ...e), "combineParameters"), Ye = class Ye extends p5 {
  constructor(r) {
    super(r);
    this.api = {};
...
var L0 = Ye, w5 = /* @__PURE__ */ n(({ children: e, effect: t }) => (de.useEffect(t, []), e), "EffectOnMount"), y5 = /* @__PURE__ */ n((e) => e,
"defaultFilter");
function R5({
...
var S5 = /* @__PURE__ */ n((e, t = []) => {
  let r = Q();
  return O0(() => (Object.entries(e).forEach(([a, o]) => r.on(a, o)), () => {
...
function E5(e, t) {
  let r = Q(), a = r.getAddonState(e) || W[e], o = B0(
    a,
    W[e] ? W[e] : t
  ), l = !1;
  o === t && t !== void 0 && (W[e] = t, l = !0), O0(() => {
