...
tten` : `"${o}" is already defined and was NOT overwritten`)) : r[o] = A[o];
  ...
  Ue.exports.configDotenv = pA.configDotenv;
  Ue.exports._configVault = pA._configVault;
  Ue.exports._parseVault = pA._parseVault;
  Ue.exports.config = pA.config;
  Ue.exports.decrypt = pA.decrypt;
  Ue.exports.parse = pA.parse;
  Ue.exports.populate = pA.populate;
  Ue.exports = pA;
});
...
var _r = j((GN, Za) => {
  "use strict";
  var Ff = require("path"), ke = "\\\\/", za = `[^${ke}]`, Je = "\\.", Nf = "\\+", kf = "\\?", eo = "\\/", Mf = "(?=.)", Wa = "[^/]", ws = `\
(?:${eo}|$)`, Xa = `(?:^|${eo})`, ds = `${Je}{1,2}${ws}`, Rf = `(?!${Je})`, bf = `(?!${Xa}${ds})`, Lf = `(?!${Je}{0,1}${ws})`, Yf = `(?!${ds}\
)`, Uf = `[^.${eo}]`, Gf = `${Wa}*?`, Va = {
    DOT_LITERAL: Je,
    PLUS_LITERAL: Nf,
    QMARK_LITERAL: kf,
    ...
    QMARK: za,
    STAR: `${za}*?`,
    DOTS_SLASH: `${Je}{1,2}(?:[${ke}]|$)`,
    NO_DOT: `(?!${Je})`,
    NO_DOTS: `(?!(?:^|[${ke}])${Je}{1,2}(?:[${ke}]|$))`,
    NO_DOT_SLASH: `(?!${Je}{0,1}(?:[${ke}]|$))`,
    NO_DOTS_SLASH: `(?!${Je}{1,2}(?:[${ke}]|$))`,
    QMARK_NO_DOT: `[^.${ke}]`,
    START_ANCHOR: `(?:^|[${ke}])`,
    END_ANCHOR: `(?:[${ke}]|$)`
  }, vf = {
...
var CE = j((PN, nE) => {
  ...
  (r, A) => {
    ...
    }, "push"), je = /* @__PURE__ */ g((Y, IA) => {
      let b = { ...h[IA], conditions: 1, inner: "" };
      b.prev = S, b.parens = F.parens, b.output = F.output;
      let N = (e.capture ? "(" : "") + b.open;
      He("parens"), rA({ type: Y, value: IA, output: F.output ? "" : m }), rA({ type: "paren", extglob: !0, value: MA(), output: N }), cA.push(
      b);
...
\\" : "")), IA === r && e.contains === !0 ? (F.output = r, F) : (F.output = Ae.wrapOutput(IA, F, A), F);
    ...
    for (; !kA(); ) {
      ...
      if (K === "(") {
        He("parens"), rA({ type: "paren", value: K });
        continue;
      }
      if (K === ")") {
...
var ZE = j((Lk, Gs) => {
  ...
  g(Rw, "escapeCommand");
  function bw(r, A) {
    return r = `${r}`, r = r.replace(/(\\*)"/g, '$1$1\\"'), r = r.replace(/(\\*)$/, "$1$1"), r = `"${r}"`, r = r.replace(Us, "^$1"), A && (r =
    r.replace(Us, "^$1")), r;
  }
  g(bw, "escapeArgument");
...
var Ho = j((Oe) => {
  ...
  Oe.ZipFS = Oe.makeEmptyArchive = Oe.DEFAULT_COMPRESSION_LEVEL = void 0;
  var xn = (fe(), te(ue)), oi = require("fs"), VB = require("stream"), cm = require("util"), ZB = xn.__importDefault(require("zlib")), Bm = rt(),
  Qm = it(), hm = Mn(), Jn = Gn(), Pe = ri(), q = xn.__importStar(ii()), nA = OA(), dt = xn.__importStar(Uo());
  Oe.DEFAULT_COMPRESSION_LEVEL = "mixed";
  function lm(r) {
  ...
  var vn = class extends Bm.BasePortableFakeFS {
    ...
    constructor(A, e) {
      ...
      libzip;
      let t = e;
      if (this.level = typeof t.level < "u" ? t.level : Oe.DEFAULT_COMPRESSION_LEVEL, A ?? (A = To()), typeof A == "string") {
    ...
    statImpl(A, e, t = {}) {
      ...
      if (typeof i < "u") {
        ...
        listings.has(e) ? Pe.S_IFDIR : this.isSymbolicLink(i) ? Pe.S_IFLNK : Pe.S_IFREG, V = x === Pe.S_IFDIR ? 493 : 420, gA = x | this.getUnixMode(
      ...
      if (this.listings.has(e)) {
        ...
        p = this.stats.mtimeMs, m = new Date(h), D = new Date(u), U = new Date(f), R = new Date(p), T = Pe.S_IFDIR | 493, x = Object.assign(
    ...
    chmodSync(A, e) {
      ...
      let s = this.getUnixMode(i, Pe.S_IFREG | 0) & -512 | e;
...
a", ...t }), this.writeFileSync(A, e, t);
    ...
    symlinkSync(A, e) {
      ...
      if (this.registerEntry(t, i), this.libzip.file.setExternalAttributes(this.zip, i, 0, 0, this.libzip.ZIP_OPSYS_UNIX, (Pe.S_IFLNK | 511) <<
      16) === -1)
        throw this.makeLibzipError(this.libzip.getError(this.zip));
      this.symlinkCount += 1;
    }
...
var $B = j((qo) => {
  ...
  qo.AliasFS = void 0;
  var fm = _e(), On = class extends fm.ProxiedFS {
    static {
      g(this, "AliasFS");
    }
...
var AQ = j((zo) => {
  ...
  zo.CwdFS = void 0;
  var wm = it(), dm = _e(), _n = OA(), Tn = class extends dm.ProxiedFS {
    static {
      g(this, "CwdFS");
    }
...
var tQ = j((Xo) => {
  ...
  Xo.JailFS = void 0;
  var pm = it(), mm = _e(), Wo = OA(), eQ = Wo.PortablePath.root, Hn = class extends mm.ProxiedFS {
    static {
      g(this, "JailFS");
    }
...
var rQ = j((Vo) => {
  ...
  Vo.LazyFS = void 0;
  var ym = _e(), jn = class extends ym.ProxiedFS {
    static {
      g(this, "LazyFS");
    }
    constructor(A, e) {
...
var oQ = j(($o) => {
  ...
  $o.PosixFS = void 0;
  var Km = _e(), qn = OA(), zn = class extends Km.ProxiedFS {
    static {
      g(this, "PosixFS");
    }
    constructor(A) {
...
var gQ = j((Ag) => {
  ...
  Ag.VirtualFS = void 0;
  var Fm = it(), Nm = _e(), we = OA(), km = /^[0-9]+$/, Wn = /^(\/(?:[^/]+\/)*?(?:\$\$virtual|__virtual__))((?:\/((?:[^/]+-)?[a-f0-9]+)(?:\/([^/]+))?)?((?:\/.*)?))$/,
...
var CQ = j((ig) => {
  ...
  var nQ = require("url"), Um = require("util"), Gm = _e(), Jm = OA(), Zn = class extends Gm.ProxiedFS {
    static {
      g(this, "NodePathFS");
    }
    constructor(A) {
...
var MQ = j((ng, gC) => {
  var kQ = Object.assign({}, require("fs")), oC = function() {
    ...
    return typeof __filename < "u" && (r = r || __filename), function(A) {
      ...
      g(rA, "alignUp");
      var je, RA, Y, IA, b, N, QA, DA, lA;
      function Kt(n) {
        je = n, e.HEAP8 = RA = new Int8Array(n), e.HEAP16 = IA = new Int16Array(n), e.HEAP32 = N = new Int32Array(n), e.HEAPU8 = Y = new Uint8Array(
      ...
      g(ih, "preRun");
      function oh() {
        rh = !0, !e.noFSInit && !c.init.initialized && c.init(), qe.init(), lg(cC);
      }
      g(oh, "initRuntime");
      function gh() {
        if (e.postRun)
...
OWTH to allow any size memory (and also make sure not to set INITIAL_MEMORY at runtime to something smaller than it was at compile time)."
      ...
      function ci(n, C) {
        ...
        return N[C + 28 >> 2] = l, ci.GMTString || (ci.GMTString = He("GMT")), N[C + 40 >> 2] = ci.GMTString, C;
      }
      g(ci, "_gmtime_r");
      function ch(n, C) {
        return ci(n, C);
      ...
      var be = {
        ...
        register: /* @__PURE__ */ g(function(n, C) {
          qe.ttys[n] = { input: [], output: [], ops: C }, c.registerDevice(n, qe.stream_ops);
        }, "register"),
        stream_ops: {
          open: /* @__PURE__ */ g(function(n) {
            var C = qe.ttys[n.node.rdev];
            if (!C)
...
`));
      ...
      var $ = {
        ...
        createDefaultDevices: /* @__PURE__ */ g(function() {
          ...
          }), c.mkdev("/dev/null", c.makedev(1, 3)), qe.register(c.makedev(5, 0), qe.default_tty_ops), qe.register(c.makedev(6, 0), qe.default_tty1_ops),
...
ers. Use --embed-file or --preload-file in emcc on the main thread."
      ...
      function Sh(n) {
        try {
          return F.grow(n - je.byteLength + 65535 >>> 16), Kt(F.buffer), 1;
        } catch {
        }
      }
...
PNOTSUPP", r[r.ZIP_ER_EOF = 17] = "ZIP_ER_EOF", r[r.ZIP_ER_INVAL = 18] = "ZIP_ER_INVAL", r[r.ZIP_ER_NOZIP = 19] = "ZIP_ER_NOZIP", r[r.ZIP_ER_INTERNAL =
  ...
  var Ny = /* @__PURE__ */ g((r) => ({
    ...
    statIndex: r.cwrap("zip_stat_index", "number", ["number", ...Te, "number", "number"]),
    fopen: r.cwrap("zip_fopen", "number", ["number", "string", "number"]),
    fopenIndex: r.cwrap("zip_fopen_index", "number", ["number", ...Te, "number"]),
    ...
    file: {
      ...
      getExternalAttributes: r.cwrap("zip_file_get_external_attributes", "number", ["number", ...Te, "number", "number", "number"]),
      setExternalAttributes: r.cwrap("zip_file_set_external_attributes", "number", ["number", ...Te, "number", "number", "number"]),
      setMtime: r.cwrap("zip_file_set_mtime", "number", ["number", ...Te, "number", "number"]),
      setCompression: r.cwrap("zip_set_file_compression", "number", ["number", ...Te, "number", "number"])
    },
    ext: {
    ...
    source: {
      fromUnattachedBuffer: r.cwrap("zip_source_buffer_create", "number", ["number", ...Te, "number", "number"]),
      fromBuffer: r.cwrap("zip_source_buffer", "number", ["number", "number", ...Te, "number"]),
      ...
      seek: r.cwrap("zip_source_seek", "number", ["number", ...Te, "number"]),
...
var ze = {
  ...
  "@storybook/builder-manager": "8.6.4",
  "@storybook/channels": "8.6.4",
  "@storybook/client-logger": "8.6.4",
  ...
  "@storybook/manager": "8.6.4",
  "@storybook/manager-api": "8.6.4",
  "@storybook/node-logger": "8.6.4",
  "@storybook/preview": "8.6.4",
  "@storybook/preview-api": "8.6.4",
  "@storybook/router": "8.6.4",
  "@storybook/telemetry": "8.6.4",
  "@storybook/theming": "8.6.4",
  "@storybook/types": "8.6.4",
  "@storybook/angular": "8.6.4",
  "@storybook/ember": "8.6.4",
  ...
  "@storybook/preact-webpack5": "8.6.4",
  "@storybook/react-native-web-vite": "8.6.4",
  "@storybook/react-vite": "8.6.4",
  "@storybook/react-webpack5": "8.6.4",
  "@storybook/server-webpack5": "8.6.4",
  "@storybook/svelte-vite": "8.6.4",
  "@storybook/svelte-webpack5": "8.6.4",
  "@storybook/sveltekit": "8.6.4",
  "@storybook/vue3-vite": "8.6.4",
  "@storybook/vue3-webpack5": "8.6.4",
  ...
  "@storybook/preset-html-webpack": "8.6.4",
  "@storybook/preset-preact-webpack": "8.6.4",
  "@storybook/preset-react-webpack": "8.6.4",
  "@storybook/preset-server-webpack": "8.6.4",
  "@storybook/preset-svelte-webpack": "8.6.4",
  "@storybook/preset-vue3-webpack": "8.6.4",
  "@storybook/html": "8.6.4",
  "@storybook/preact": "8.6.4",
  "@storybook/react": "8.6.4",
  "@storybook/server": "8.6.4",
...
typeof r.write == "function" && typeof r.end == "function", "isWritable"), Le = Symbol("EOF"), Ye = Symbol("maybeEmitEnd"), Xe = Symbol("emi\
...
buffer", { get: /* @__PURE__ */ g(() => this[FA], "get") }), e && e.debugExposePipes === !0 && Object.defineProperty(this, "pipes", { get: /* @__PURE__ */ g(
  ...
  [yi](A = !1) {
    ...
    !A && !this[FA].length && !this[Le] && this.emit("drain");
  }
  [sI](A) {
  ...
  [Ye]() {
    !this[pi] && !this[Xe] && !this[fA] && this[FA].length === 0 && this[Le] && (this[pi] = !0, this.emit("end"), this.emit("prefinish"), this.
    ...
    return {
      next: /* @__PURE__ */ g(() => {
        ...
        let o, s, I = /* @__PURE__ */ g((u) => {
          ...
          this.off("error", I), this.off("end", B), this.off(fA, h), this.pause(), o({ value: u, done: !!this[Le] });
        }, "ondata"), B = /* @__PURE__ */ g(() => {
...
}, "createLogStream"), ns = /* @__PURE__ */ g((r) => Object.keys(ze).includes(r), "isCorePackage");
...
}, "getProjectRoot"), Bs = /* @__PURE__ */ g((r) => r.split(process.platform === "win32" ? ";" : ":").filter(Boolean).map((A) => (0, Ge.resolve)(
"./", A)), "nodePathsToArray"), hf = /^\.{1,2}([/\\]|$)/;
function Qs(r) {
  return hf.test(r) ? r : `.${Ge.sep}${r}`;
}
...
var dE = require("node:fs"), ve = require("node:path"), pE = require("@storybook/core/server-errors"), mE = J(ks(), 1);
var Io = "", uw = "**/*.@(mdx|stories.@(js|jsx|mjs|ts|tsx))", fw = /* @__PURE__ */ g((r, A) => {
  try {
    return (0, dE.lstatSync)((0, ve.resolve)(r, A)).isDirectory();
  } catch {
    return !1;
  }
  ...
  let t = (0, ve.resolve)(r, e), i = (0, ve.relative)(A, t);
  return Qs(i);
  ...
  if (typeof r == "string") {
    ...
    if (B.isGlob) {
      ...
      titlePrefix: Io,
      directory: (0, ve.dirname)(r),
      files: (0, ve.basename)(r)
    };
  } else
    i = {
      titlePrefix: Io,
...
var ee = class {
  ...
  async installDependencies() {
    xe.log("Installing dependencies..."), xe.log();
    try {
      await this.runInstall();
    } catch (A) {
      throw xe.error("An error occurred while installing dependencies."), new et(A);
    }
  }
  packageJsonPath() {
    if (!this.cwd)
  ...
  async addDependencies(A, e) {
    ...
    if (t) {
      ...
      try {
        ...
        throw xe.error(`
An error occurred while installing dependencies:`), xe.log(i.message), new et(i);
      }
  }
  /**
  ...
  async removeDependencies(A, e) {
    ...
    if (t) {
      ...
      try {
        ...
        throw xe.error("An error occurred while removing dependencies."), xe.log(String(i)), new et(i);
      }
  }
  /**
  ...
  getVersionedPackages(A) {
    return Promise.all(
      A.map(async (e) => {
        let [t, i] = un(e), o = await this.latestVersion(t, i), I = ze[t];
