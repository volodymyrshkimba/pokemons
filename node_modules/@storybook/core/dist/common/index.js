...
var ga = j((yM, oa) => {
  ...
  (r, A) => {
    ...
    RA = F.advance = () => r[++F.index] || "", XA = /* @__PURE__ */ g(() => r.slice(F.index + 1), "remaining"), DA = /* @__PURE__ */ g((Y = "", aA = 0) => {
      ...
      if (BA.length && Y.type !== "paren" && (BA[BA.length - 1].inner += Y.value), (Y.value || Y.output) && tt(Y), S && S.type === "text" &&
      Y.type === "text") {
...
\\" : "")), aA === r && e.contains === !0 ? (F.output = r, F) : (F.output = Ae.wrapOutput(aA, F, A), F);
    ...
    for (; !MA(); ) {
      ...
      if (F.brackets > 0 && (K !== "]" || S.value === "[" || S.value === "[^")) {
        ...
        `\\${K}`), e.posix === !0 && K === "!" && S.value === "[" && (K = "^"), S.value += K, tt({ value: K });
        continue;
      }
      if (F.quotes === 1 && K !== '"') {
        K = Ae.escapeRegex(K), S.value += K, tt({ value: K });
        continue;
      }
      if (K === '"') {
      ...
      if (K === "]") {
        ...
        Fe("brackets");
        let b = S.value.slice(1);
        if (S.posix !== !0 && b[0] === "^" && !b.includes("/") && (K = `/${K}`), S.value += K, tt({ value: K }), e.literalBrackets === !1 ||
        Ae.hasRegexChars(b))
          continue;
...
var ja = j((GR, Jg) => {
  ...
  g(qf, "escapeCommand");
  function zf(r, A) {
    return r = `${r}`, r = r.replace(/(\\*)"/g, '$1$1\\"'), r = r.replace(/(\\*)$/, "$1$1"), r = `"${r}"`, r = r.replace(Gg, "^$1"), A && (r =
    r.replace(Gg, "^$1")), r;
  }
  g(zf, "escapeArgument");
...
var Xe = j((Vi) => {
  ...
  Vi.NodeFS = void 0;
  var sm = (he(), Ie(Qe)), nm = sm.__importDefault(G("fs")), Cm = We(), wc = br(), L = _A(), Ls = class extends Cm.BasePortableFakeFS {
    static {
      g(this, "NodeFS");
    }
...
var eo = j((Ge) => {
  ...
  var xs = (he(), Ie(Qe)), Lr = G("fs"), mc = G("stream"), Qm = G("util"), yc = xs.__importDefault(G("zlib")), hm = We(), lm = Xe(), um = Ms(),
...
var Je = j((to) => {
  ...
  to.ProxiedFS = void 0;
  var wm = We(), Ps = class extends wm.FakeFS {
    static {
      g(this, "ProxiedFS");
    }
    getExtractHint(A) {
...
var Sc = j((io) => {
  ...
  io.CwdFS = void 0;
  var pm = Xe(), mm = Je(), _s = _A(), Ts = class extends mm.ProxiedFS {
    static {
      g(this, "CwdFS");
    }
...
var Fc = j((go) => {
  ...
  go.JailFS = void 0;
  var ym = Xe(), Dm = Je(), oo = _A(), Kc = oo.PortablePath.root, Hs = class extends Dm.ProxiedFS {
    static {
      g(this, "JailFS");
    }
...
var kc = j((no) => {
  ...
  no.NoFS = void 0;
  var Km = We(), Fm = _A(), J = /* @__PURE__ */ g(() => Object.assign(new Error("ENOSYS: unsupported filesystem access"), { code: "ENOSYS" }),
...
var Rc = j((Io) => {
  ...
  Object.defineProperty(Io, "__esModule", { value: !0 });
  Io.VirtualFS = void 0;
  var km = Xe(), Mm = Je(), le = _A(), Rm = /^[0-9]+$/, Ws = /^(\/(?:[^/]+\/)*?(?:\$\$virtual|__virtual__))((?:\/((?:[^/]+-)?[a-f0-9]+)(?:\/([^/]+))?)?((?:\/.*)?))$/,
...
var bc = j((Ze) => {
  ...
  var Lm = (he(), Ie(Qe)), ao = G("fs"), Ym = We(), Um = Xe(), Eo = eo(), co = Gs(), zA = Lm.__importStar(br()), ct = _A(), WA = 4278190080,
...
var xc = j((lo) => {
  ...
  var Pm = G("readline"), HA = Symbol("kBaseFs"), $e = Symbol("kFd"), At = Symbol("kClosePromise"), Qo = Symbol("kCloseResolve"), ho = Symbol(
  "kCloseReject"), xt = Symbol("kRefs"), ue = Symbol("kRef"), fe = Symbol("kUnref"), $s = class {
    static {
      g(this, "FileHandle");
    }
    constructor(A, e) {
      this[Uc] = 1, this[Gc] = void 0, this[Jc] = void 0, this[vc] = void 0, this[HA] = e, this[$e] = A;
    }
    get fd() {
      return this[$e];
    }
    ...
    close() {
      ...
      if (this[xt]--, this[xt] === 0) {
        let A = this[$e];
        this[$e] = -1, this[At] = this[HA].closePromise(A).finally(() => {
          this[At] = void 0;
        });
      } else
        this[At] = new Promise((A, e) => {
          ...
          this[At] = void 0, this[ho] = void 0, this[Qo] = void 0;
        });
      return this[At];
    }
    [(Uc = xt, Gc = At, Jc = Qo, vc = ho, ue)](A) {
      if (this[$e] === -1) {
    ...
    [fe]() {
      if (this[xt]--, this[xt] === 0) {
        let A = this[$e];
        this[$e] = -1, this[HA].closePromise(A).then(this[Qo], this[ho]);
      }
    }
  };
  lo.FileHandle = $s;
...
var qc = j((et) => {
  ...
  et.xfs = void 0;
  var Hm = (he(), Ie(Qe)), jm = Hm.__importDefault(G("os")), qm = Xe(), Gr = _A();
  function Hc(r) {
  ...
  function jc() {
    if (An)
      return An;
    let r = Gr.npath.toPortablePath(jm.default.tmpdir()), A = et.xfs.realpathSync(r);
  ...
  g(jc, "initTmpEnv");
  et.xfs = Object.assign(new qm.NodeFS(), {
    detachTemp(r) {
      we.delete(r);
    },
    mktempSync(r) {
    ...
    async rmtempPromise() {
      await Promise.all(Array.from(we.values()).map(async (r) => {
        try {
          await et.xfs.removePromise(r, { maxRetries: 0 }), we.delete(r);
        } catch {
        }
      }));
    },
    rmtempSync() {
      for (let r of we)
        try {
          et.xfs.removeSync(r), we.delete(r);
        } catch {
        }
    }
  });
...
var rB = j((uo, sn) => {
  var tB = Object.assign({}, G("fs")), gn = function() {
    ...
    return typeof __filename < "u" && (r = r || __filename), function(A) {
      ...
      function Do(n) {
        if (rt--, e.monitorRunDependencies && e.monitorRunDependencies(rt), rt == 0 && (yo !== null && (clearInterval(yo), yo = null), jt)) {
          var C = jt;
          jt = null, C();
        }
      }
...
var ch = /* @__PURE__ */ g((r) => !rC.has(r), "shouldWarn"), ZS = Symbol("type"), _e = /* @__PURE__ */ g((r) => r && r === Math.floor(r) && r >
0 && isFinite(r), "isPosInt"), oC = /* @__PURE__ */ g((r) => _e(r) ? r <= Math.pow(2, 8) ? Uint8Array : r <= Math.pow(2, 16) ? Uint16Array :
...
ion" && (this.#t = B), typeof h == "function" ? (this.#r = h, this.#h = []) : (this.#r = void 0, this.#h = void 0), this.#d = !!this.#t, this.#Q =
    ...
    this.allowStaleOnFetchAbort = !!V, this.ignoreFetchAbort = !!gA, this.maxEntrySize !== 0) {
      if (this.#e !== 0 && !_e(this.#e))
        throw new TypeError("maxSize must be a positive integer if specified");
      if (!_e(this.maxEntrySize))
        throw new TypeError("maxEntrySize must be a positive integer if specified");
      this.#k();
    }
    if (this.allowStale = !!E, this.noDeleteOnStaleGet = !!M, this.updateAgeOnGet = !!s, this.updateAgeOnHas = !!I, this.ttlResolution = _e(
...
var gC = typeof process == "object" && process ? process : {
  stdout: null,
  stderr: null
}, Qh = /* @__PURE__ */ g((r) => !!r && typeof r == "object" && (r instanceof He || r instanceof IC || hh(r) || lh(r)), "isStream"), hh = /* @__PURE__ */ g(
...
write == "function" && typeof r.end == "function", "isWritable"), Me = Symbol("EOF"), Re = Symbol("maybeEmitEnd"), Te = Symbol("emittedEnd"),
...
"buffer", "isEncodingOptions"), He = class extends To {
  static {
    g(this, "Minipass");
  }
  [FA] = !1;
  ...
  [Re]() {
    !this[zr] && !this[Te] && !this[wA] && this[NA].length === 0 && this[Me] && (this[zr] = !0, this.emit("end"), this.emit("prefinish"), this.
  ...
  [CC]() {
    return this[Te] ? !1 : (this[Te] = !0, this.readable = !1, this[pe] ? (gr(() => this[Po]()), !0) : this[Po]());
  }
  [Po]() {
    if (this[Dt]) {
      let e = this[Dt].end();
...
(r) => {
  ...
  *iterateSync(A = this.cwd, e = {}) {
  ...
  stream(A = this.cwd, e = {}) {
    typeof A == "string" ? A = this.cwd.resolve(A) : A instanceof GA || (e = A, A = this.cwd);
    let { withFileTypes: t = !0, follow: i = !1, filter: o, walkFilter: s } = e, I = new He({ objectMode: !0 });
  ...
  streamSync(A = this.cwd, e = {}) {
    typeof A == "string" ? A = this.cwd.resolve(A) : A instanceof GA || (e = A, A = this.cwd);
    let { withFileTypes: t = !0, follow: i = !1, filter: o, walkFilter: s } = e, I = new He({ objectMode: !0 }), E = /* @__PURE__ */ new Set();
    (!o || o(A)) && I.write(t ? A : A.fullpath());
...
var _h = /* @__PURE__ */ g((r, A) => typeof r == "string" ? new kt([r], A) : Array.isArray(r) ? new kt(r, A) : r, "makeIgnore"), si = class {
  ...
  results;
  constructor(A, e, t) {
    super(A, e, t), this.results = new He({
      signal: this.signal,
      objectMode: !0
...
var NC = CA(jA(), 1);
async function ai(r) {
  let A = `{${Array.from(Mo).join(",")}}`, e = await ni(je(FC(r, `main${A}`))), [t] = e;
...
}, "createLogStream"), fI = /* @__PURE__ */ g((r) => Object.keys(it).includes(r), "isCorePackage");
...
import mu from "fs";
import yu from "path";
var qe = yu.join(kI.default.get(), ".env");
...
var Si = "", Rf = "**/*.@(mdx|stories.@(js|jsx|mjs|ts|tsx))", bf = /* @__PURE__ */ g((r, A) => {
  ...
  let o = je(i.files), { directory: s } = i, I = je(
    Lf({
      configDir: A,
      workingDir: e,
      directory: s
...
An error occurred while installing dependencies:`), Ye.log(i.message), new nt(i);
  ...
  getVersionedPackages(A) {
    return Promise.all(
      A.map(async (e) => {
        let [t, i] = ec(e), o = await this.latestVersion(t, i), I = it[t];
